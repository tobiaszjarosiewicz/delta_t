...
def plot_lag(inp_dict):
    ...
    plt.axvline(x=279.5, linewidth=1, color='b')
    plt.axvline(x=313.5, linewidth=1, color='b')
    plt.axvline(x=370.5, linewidth=1, color='b')
    plt.axvline(x=381.5, linewidth=1, color='b')
    plt.ylabel('[s]')
    plt.xlabel('[n]')
    plt.legend()
    plt.grid(True)
